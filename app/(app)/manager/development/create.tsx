...
import { useCreateDevelopmentPlan } from '../../../../lib/api/development';
...
export default function CreateDevelopmentPlanScreen() {
  const { t } = useI18n();
  ...
  const handleSubmit = () => {
    ...
    createPlan.mutate(
      ...
      },
      {
        ...
        onError: () => Alert.alert(t('error'), t('dev_createError')),
      },
    );
  };
  ...
  return (
    ...
    >
      <Stack.Screen options={{ headerTitle: t('dev_new'), headerShown: true }} />
