...
import { useCreateShift, useTeamMembers } from '../../../../lib/api/manager-shifts';
...
export default function CreateShiftScreen() {
  ...
  const handleSubmit = () => {
    ...
    createShift.mutate(
      ...
      },
      {
        ...
        onError: () => Alert.alert(t('error'), t('shifts_createError')),
      },
    );
  };
  ...
  return (
    ...
    >
      <Stack.Screen options={{ headerTitle: t('shifts_new'), headerShown: true }} />
